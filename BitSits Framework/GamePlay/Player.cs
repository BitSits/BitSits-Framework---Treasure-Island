...
namespace BitSits_Framework
{
    class Player
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            body.ApplyLinearImpulse(direction * (inSea ? 0.75f : 1f), body.Position);
        ...
        public void DrawHealthBar(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(gameContent.healthBar, v, new Color(Color.White, 0.8f));
            spriteBatch.Draw(gameContent.healthBar, v, new Rectangle(0, 0, (int)(health / MaxHelth * size.X),
                (int)size.Y), new Color(Color.Crimson, 0.8f));
        }
    }
}
